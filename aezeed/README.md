...
[In this PR](https://github.com/machinecoin-project/lnd/pull/773) we add a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/machinecoin-project/lnd/aezeed
...
PASS
ok      github.com/machinecoin-project/lnd/aezeed  4.168s
```
