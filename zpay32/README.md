...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/machinecoin-project/lnd/zpay32)
...
```bash
$ go get -u github.com/machinecoin-project/lnd/zpay32
```
